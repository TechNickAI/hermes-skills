...
const PROJECT_DIR =
  ...
  "/Users/<user>/.openclaw/workspace-<agent-d>/memory/projects/btc-recovery-changetip";
```
...
```js
env: {
  BTC_PROJECT_DIR: '/Users/<user>/.openclaw/workspace-<agent-d>/memory/projects/btc-recovery-changetip',
}
```
